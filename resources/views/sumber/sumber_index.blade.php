            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="#">Sumber Pemasukan</a></li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('sumber-pemasukan/add')}}" class="btn btn-sm btn-neutral">Tambah</a>
            </div>
          </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-lg-6 col-5 text-center">
                              <a href="{{ url('sumber-pemasukan/'.$sb->id)}}" class="btn btn-sm  btn-info">Edit</a>
                              <a sumber-id="{{$sb->id}}"class="btn-hapus btn btn-sm btn-danger" href="{{ url('sumber-pemasukan/'.$sb->id)}}" >Delete</a>
                            </div>
                            </center>
                        </td>
                    </tr>
